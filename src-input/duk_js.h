...
#define DUK_CALL_FLAG_IS_RESUME              (1 << 1)  /* duk_handle_call_unprotected: setup for a resume() */
#define DUK_CALL_FLAG_IS_TAILCALL            (1 << 2)  /* duk_handle_call_unprotected: setup for a tail call */
#define DUK_CALL_FLAG_DIRECT_EVAL            (1 << 3)  /* duk_handle_call_unprotected: call is a direct eval call */
#define DUK_CALL_FLAG_ALLOW_ECMATOECMA       (1 << 4)  /* duk_handle_call_unprotected: ecma-to-ecma call with executor reuse is possible */
